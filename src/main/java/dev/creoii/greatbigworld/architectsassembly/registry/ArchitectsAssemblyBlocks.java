...
public final class ArchitectsAssemblyBlocks {
    ...
    private static void registerMiscBlocks() {
        ...
        COPPER_PRESSURE_PLATE = RegistryHelper.registerBlock(Identifier.fromNamespaceAndPath(GreatBigWorld.NAMESPACE, "copper_pressure_plate"), settings -> new CopperPressurePlateBlock(WeatheringCopper.WeatherState.UNAFFECTED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE).sound(SoundType.COPPER).mapColor(MapColor.COLOR_ORANGE));
        EXPOSED_COPPER_PRESSURE_PLATE = RegistryHelper.registerBlock(Identifier.fromNamespaceAndPath(GreatBigWorld.NAMESPACE, "exposed_copper_pressure_plate"), settings -> new CopperPressurePlateBlock(WeatheringCopper.WeatherState.EXPOSED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE).sound(SoundType.COPPER).mapColor(MapColor.TERRACOTTA_LIGHT_GRAY));
        WEATHERED_COPPER_PRESSURE_PLATE = RegistryHelper.registerBlock(Identifier.fromNamespaceAndPath(GreatBigWorld.NAMESPACE, "weathered_copper_pressure_plate"), settings -> new CopperPressurePlateBlock(WeatheringCopper.WeatherState.WEATHERED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE).sound(SoundType.COPPER).mapColor(MapColor.WARPED_STEM));
        OXIDIZED_COPPER_PRESSURE_PLATE = RegistryHelper.registerBlock(Identifier.fromNamespaceAndPath(GreatBigWorld.NAMESPACE, "oxidized_copper_pressure_plate"), settings -> new CopperPressurePlateBlock(WeatheringCopper.WeatherState.OXIDIZED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE).sound(SoundType.COPPER).mapColor(MapColor.WARPED_NYLIUM));
        WAXED_COPPER_PRESSURE_PLATE = RegistryHelper.registerBlock(Identifier.fromNamespaceAndPath(GreatBigWorld.NAMESPACE, "waxed_copper_pressure_plate"), settings -> new CopperPressurePlateBlock(WeatheringCopper.WeatherState.UNAFFECTED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE).sound(SoundType.COPPER).mapColor(MapColor.COLOR_ORANGE));
        WAXED_EXPOSED_COPPER_PRESSURE_PLATE = RegistryHelper.registerBlock(Identifier.fromNamespaceAndPath(GreatBigWorld.NAMESPACE, "waxed_exposed_copper_pressure_plate"), settings -> new CopperPressurePlateBlock(WeatheringCopper.WeatherState.EXPOSED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE).sound(SoundType.COPPER).mapColor(MapColor.TERRACOTTA_LIGHT_GRAY));
        WAXED_WEATHERED_COPPER_PRESSURE_PLATE = RegistryHelper.registerBlock(Identifier.fromNamespaceAndPath(GreatBigWorld.NAMESPACE, "waxed_weathered_copper_pressure_plate"), settings -> new CopperPressurePlateBlock(WeatheringCopper.WeatherState.WEATHERED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE).sound(SoundType.COPPER).mapColor(MapColor.WARPED_STEM));
        WAXED_OXIDIZED_COPPER_PRESSURE_PLATE = RegistryHelper.registerBlock(Identifier.fromNamespaceAndPath(GreatBigWorld.NAMESPACE, "waxed_oxidized_copper_pressure_plate"), settings -> new CopperPressurePlateBlock(WeatheringCopper.WeatherState.OXIDIZED, settings), BlockBehaviour.Properties.ofFullCopy(Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE).sound(SoundType.COPPER).mapColor(MapColor.WARPED_NYLIUM));
