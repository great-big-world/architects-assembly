...
public final class ArchitectsAssemblyBlocks {
    ...
    private static void registerDecorativeBlocks() {
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_glass"), CHISELED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_glass_pane"), CHISELED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_brown_stained_glass"), CHISELED_BROWN_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_brown_stained_glass_pane"), CHISELED_BROWN_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_red_stained_glass"), CHISELED_RED_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_red_stained_glass_pane"), CHISELED_RED_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_orange_stained_glass"), CHISELED_ORANGE_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_orange_stained_glass_pane"), CHISELED_ORANGE_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_yellow_stained_glass"), CHISELED_YELLOW_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_yellow_stained_glass_pane"), CHISELED_YELLOW_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_lime_stained_glass"), CHISELED_LIME_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_lime_stained_glass_pane"), CHISELED_LIME_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_green_stained_glass"), CHISELED_GREEN_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_green_stained_glass_pane"), CHISELED_GREEN_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_cyan_stained_glass"), CHISELED_CYAN_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_cyan_stained_glass_pane"), CHISELED_CYAN_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_blue_stained_glass"), CHISELED_BLUE_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_blue_stained_glass_pane"), CHISELED_BLUE_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_light_blue_stained_glass"), CHISELED_LIGHT_BLUE_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_light_blue_stained_glass_pane"), CHISELED_LIGHT_BLUE_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_pink_stained_glass"), CHISELED_PINK_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_pink_stained_glass_pane"), CHISELED_PINK_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_magenta_stained_glass"), CHISELED_MAGENTA_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_magenta_stained_glass_pane"), CHISELED_MAGENTA_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_purple_stained_glass"), CHISELED_PURPLE_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_purple_stained_glass_pane"), CHISELED_PURPLE_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_black_stained_glass"), CHISELED_BLACK_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_black_stained_glass_pane"), CHISELED_BLACK_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_gray_stained_glass"), CHISELED_GRAY_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_gray_stained_glass_pane"), CHISELED_GRAY_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_light_gray_stained_glass"), CHISELED_LIGHT_GRAY_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_light_gray_stained_glass_pane"), CHISELED_LIGHT_GRAY_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_white_stained_glass"), CHISELED_WHITE_STAINED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_white_stained_glass_pane"), CHISELED_WHITE_STAINED_GLASS_PANE);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "lapis_stairs"), LAPIS_STAIRS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "lapis_slab"), LAPIS_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_lapis_slab"), VERTICAL_LAPIS_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "lapis_wall"), LAPIS_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "polished_lapis_block"), POLISHED_LAPIS_BLOCK);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "polished_lapis_stairs"), POLISHED_LAPIS_STAIRS);
        ...
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "mossy_brick_slab"), MOSSY_BRICK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_mossy_brick_slab"), VERTICAL_MOSSY_BRICK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "mossy_brick_wall"), MOSSY_BRICK_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "glass"), GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "shattered_glass"), SHATTERED_GLASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_oak_planks"), CHISELED_OAK_PLANKS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_oak_log"), CHISELED_OAK_LOG);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_oak_wood"), CHISELED_OAK_WOOD);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "stripped_chiseled_oak_log"), STRIPPED_CHISELED_OAK_LOG);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "stripped_chiseled_oak_wood"), STRIPPED_CHISELED_OAK_WOOD);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "cut_copper_wall"), CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "exposed_cut_copper_wall"), EXPOSED_CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "weathered_cut_copper_wall"), WEATHERED_CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "oxidized_cut_copper_wall"), OXIDIZED_CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "waxed_cut_copper_wall"), WAXED_CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "waxed_exposed_cut_copper_wall"), WAXED_EXPOSED_CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "waxed_weathered_cut_copper_wall"), WAXED_WEATHERED_CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "waxed_oxidized_cut_copper_wall"), WAXED_OXIDIZED_CUT_COPPER_WALL);
    ...
    private static void registerVerticalSlabs() {
        ...
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_spruce_slab"), VERTICAL_SPRUCE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_birch_slab"), VERTICAL_BIRCH_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_jungle_slab"), VERTICAL_JUNGLE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_dark_oak_slab"), VERTICAL_DARK_OAK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_acacia_slab"), VERTICAL_ACACIA_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_mangrove_slab"), VERTICAL_MANGROVE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_cherry_slab"), VERTICAL_CHERRY_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_bamboo_slab"), VERTICAL_BAMBOO_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_bamboo_mosaic_slab"), VERTICAL_BAMBOO_MOSAIC_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_crimson_slab"), VERTICAL_CRIMSON_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_warped_slab"), VERTICAL_WARPED_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_stone_slab"), VERTICAL_STONE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_smooth_stone_slab"), VERTICAL_SMOOTH_STONE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_sandstone_slab"), VERTICAL_SANDSTONE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_cut_sandstone_slab"), VERTICAL_CUT_SANDSTONE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_petrified_oak_slab"), VERTICAL_PETRIFIED_OAK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_cobblestone_slab"), VERTICAL_COBBLESTONE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_brick_slab"), VERTICAL_BRICK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_stone_brick_slab"), VERTICAL_STONE_BRICK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_mud_brick_slab"), VERTICAL_MUD_BRICK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_nether_brick_slab"), VERTICAL_NETHER_BRICK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_quartz_slab"), VERTICAL_QUARTZ_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_red_sandstone_slab"), VERTICAL_RED_SANDSTONE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_cut_red_sandstone_slab"), VERTICAL_CUT_RED_SANDSTONE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_purpur_slab"), VERTICAL_PURPUR_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_prismarine_slab"), VERTICAL_PRISMARINE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_prismarine_brick_slab"), VERTICAL_PRISMARINE_BRICK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_dark_prismarine_slab"), VERTICAL_DARK_PRISMARINE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_granite_slab"), VERTICAL_GRANITE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_polished_granite_slab"), VERTICAL_POLISHED_GRANITE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_andesite_slab"), VERTICAL_ANDESITE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_polished_andesite_slab"), VERTICAL_POLISHED_ANDESITE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_diorite_slab"), VERTICAL_DIORITE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_polished_diorite_slab"), VERTICAL_POLISHED_DIORITE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_smooth_sandstone_slab"), VERTICAL_SMOOTH_SANDSTONE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_smooth_quartz_slab"), VERTICAL_SMOOTH_QUARTZ_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_smooth_red_sandstone_slab"), VERTICAL_SMOOTH_RED_SANDSTONE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_mossy_stone_brick_slab"), VERTICAL_MOSSY_STONE_BRICK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_end_stone_brick_slab"), VERTICAL_END_STONE_BRICK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_red_nether_brick_slab"), VERTICAL_RED_NETHER_BRICK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_blackstone_slab"), VERTICAL_BLACKSTONE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_polished_blackstone_slab"), VERTICAL_POLISHED_BLACKSTONE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_polished_blackstone_brick_slab"), VERTICAL_POLISHED_BLACKSTONE_BRICK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_oxidized_cut_copper_slab"), VERTICAL_OXIDIZED_CUT_COPPER_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_weathered_cut_copper_slab"), VERTICAL_WEATHERED_CUT_COPPER_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_exposed_cut_copper_slab"), VERTICAL_EXPOSED_CUT_COPPER_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_cut_copper_slab"), VERTICAL_CUT_COPPER_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_waxed_oxidized_cut_copper_slab"), VERTICAL_WAXED_OXIDIZED_CUT_COPPER_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_waxed_weathered_cut_copper_slab"), VERTICAL_WAXED_WEATHERED_CUT_COPPER_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_waxed_exposed_cut_copper_slab"), VERTICAL_WAXED_EXPOSED_CUT_COPPER_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_waxed_cut_copper_slab"), VERTICAL_WAXED_CUT_COPPER_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_cobbled_deepslate_slab"), VERTICAL_COBBLED_DEEPSLATE_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_polished_deepslate_slab"), VERTICAL_POLISHED_DEEPSLATE_SLAB);
    ...
    private static void registerMissingBlocks() {
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "quartz_brick_stairs"), QUARTZ_BRICK_STAIRS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "quartz_brick_slab"), QUARTZ_BRICK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_quartz_brick_slab"), VERTICAL_QUARTZ_BRICK_SLAB);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "quartz_brick_wall"), QUARTZ_BRICK_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "prismarine_brick_wall"), PRISMARINE_BRICK_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "dark_prismarine_wall"), DARK_PRISMARINE_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "smooth_sandstone_wall"), SMOOTH_SANDSTONE_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "smooth_red_sandstone_wall"), SMOOTH_RED_SANDSTONE_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "polished_granite_wall"), POLISHED_GRANITE_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "polished_andesite_wall"), POLISHED_ANDESITE_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "polished_diorite_wall"), POLISHED_DIORITE_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "purpur_wall"), PURPUR_WALL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "potted_short_grass"), POTTED_SHORT_GRASS);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "cracked_mud_bricks"), CRACKED_MUD_BRICKS);
    ...
    private static void registerImprovedBlocks() {
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "torch"), TORCH);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "soul_torch"), SOUL_TORCH);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "redstone_lamp"), REDSTONE_LAMP);
    }
    ...
    private static void registerMiscBlocks() {
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "sawmill"), SAWMILL);
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "copper_pressure_plate"), COPPER_PRESSURE_PLATE);
    }
