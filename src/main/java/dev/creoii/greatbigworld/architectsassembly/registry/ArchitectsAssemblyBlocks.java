...
public final class ArchitectsAssemblyBlocks {
    ...
    public static final Block POLISHED_LAPIS_STAIRS = new StairsBlock(POLISHED_LAPIS_BLOCK.getDefaultState(), AbstractBlock.Settings.copy(Blocks.LAPIS_BLOCK));
    public static final Block POLISHED_LAPIS_SLAB = new SlabBlock(AbstractBlock.Settings.copy(Blocks.LAPIS_BLOCK));
