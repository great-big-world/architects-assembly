...
public final class ArchitectsAssemblyBlocks {
    ...
    private static void registerDecorativeBlocks() {
        ...
        CHISELED_OAK_LOG = RegistryHelper.registerBlock(Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_oak_log"), AbstractBlock.Settings.copy(Blocks.OAK_LOG));
        CHISELED_OAK_WOOD = RegistryHelper.registerBlock(Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_oak_wood"), AbstractBlock.Settings.copy(Blocks.OAK_WOOD));
        STRIPPED_CHISELED_OAK_LOG = RegistryHelper.registerBlock(Identifier.of(GreatBigWorld.NAMESPACE, "stripped_chiseled_oak_log"), AbstractBlock.Settings.copy(Blocks.STRIPPED_OAK_LOG));
        STRIPPED_CHISELED_OAK_WOOD = RegistryHelper.registerBlock(Identifier.of(GreatBigWorld.NAMESPACE, "stripped_chiseled_oak_wood"), AbstractBlock.Settings.copy(Blocks.STRIPPED_OAK_WOOD));
    ...
    public static final Block VERTICAL_RESIN_BRICK_SLAB = new VerticalSlabBlock(AbstractBlock.Settings.copy(Blocks.RESIN_BRICKS));
    ...
    private static void registerVerticalSlabs() {
        ...
        Registry.register(Registries.BLOCK, Identifier.of(GreatBigWorld.NAMESPACE, "vertical_resin_brick_slab"), VERTICAL_RESIN_BRICK_SLAB);
