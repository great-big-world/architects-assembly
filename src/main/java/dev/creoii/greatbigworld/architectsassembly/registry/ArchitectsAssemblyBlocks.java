...
public final class ArchitectsAssemblyBlocks {
    ...
    private static void registerDecorativeBlocks() {
        ...
        Registry.register(Registries.BLOCK, new Identifier(ArchitectsAssembly.NAMESPACE, "lapis_stairs"), LAPIS_STAIRS);
        Registry.register(Registries.BLOCK, new Identifier(ArchitectsAssembly.NAMESPACE, "lapis_slab"), LAPIS_SLAB);
        Registry.register(Registries.BLOCK, new Identifier(ArchitectsAssembly.NAMESPACE, "vertical_lapis_slab"), VERTICAL_LAPIS_SLAB);
        Registry.register(Registries.BLOCK, new Identifier(ArchitectsAssembly.NAMESPACE, "lapis_wall"), LAPIS_WALL);
        ...
        Registry.register(Registries.BLOCK, new Identifier(ArchitectsAssembly.NAMESPACE, "polished_lapis_wall"), POLISHED_LAPIS_WALL);
