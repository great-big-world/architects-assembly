...
public final class ArchitectsAssemblyBlocks {
    ...
    public static final Block CUT_COPPER_WALL = new WallBlock(FabricBlockSettings.copyShallow(Blocks.CUT_COPPER).solid());
    public static final Block EXPOSED_CUT_COPPER_WALL = new WallBlock(FabricBlockSettings.copyShallow(Blocks.EXPOSED_CUT_COPPER).solid());
    public static final Block WEATHERED_CUT_COPPER_WALL = new WallBlock(FabricBlockSettings.copyShallow(Blocks.WEATHERED_CUT_COPPER).solid());
    public static final Block OXIDIZED_CUT_COPPER_WALL = new WallBlock(FabricBlockSettings.copyShallow(Blocks.OXIDIZED_CUT_COPPER).solid());
    public static final Block WAXED_CUT_COPPER_WALL = new WallBlock(FabricBlockSettings.copyShallow(Blocks.WAXED_CUT_COPPER).solid());
    public static final Block WAXED_EXPOSED_CUT_COPPER_WALL = new WallBlock(FabricBlockSettings.copyShallow(Blocks.WAXED_EXPOSED_CUT_COPPER).solid());
    public static final Block WAXED_WEATHERED_CUT_COPPER_WALL = new WallBlock(FabricBlockSettings.copyShallow(Blocks.WAXED_WEATHERED_CUT_COPPER).solid());
    public static final Block WAXED_OXIDIZED_CUT_COPPER_WALL = new WallBlock(FabricBlockSettings.copyShallow(Blocks.WAXED_OXIDIZED_CUT_COPPER).solid());
    ...
    private static void registerDecorativeBlocks() {
        ...
        Registry.register(Registries.BLOCK, new Identifier(ArchitectsAssembly.NAMESPACE, "cut_copper_wall"), CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, new Identifier(ArchitectsAssembly.NAMESPACE, "exposed_cut_copper_wall"), EXPOSED_CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, new Identifier(ArchitectsAssembly.NAMESPACE, "weathered_cut_copper_wall"), WEATHERED_CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, new Identifier(ArchitectsAssembly.NAMESPACE, "oxidized_cut_copper_wall"), OXIDIZED_CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, new Identifier(ArchitectsAssembly.NAMESPACE, "waxed_cut_copper_wall"), WAXED_CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, new Identifier(ArchitectsAssembly.NAMESPACE, "waxed_exposed_cut_copper_wall"), WAXED_EXPOSED_CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, new Identifier(ArchitectsAssembly.NAMESPACE, "waxed_weathered_cut_copper_wall"), WAXED_WEATHERED_CUT_COPPER_WALL);
        Registry.register(Registries.BLOCK, new Identifier(ArchitectsAssembly.NAMESPACE, "waxed_oxidized_cut_copper_wall"), WAXED_OXIDIZED_CUT_COPPER_WALL);
