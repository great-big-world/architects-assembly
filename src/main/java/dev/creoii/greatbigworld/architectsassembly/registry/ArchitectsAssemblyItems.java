...
public final class ArchitectsAssemblyItems {
    ...
    private static void registerItems() {
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "brown_item_frame"), BROWN_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "red_item_frame"), RED_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "orange_item_frame"), ORANGE_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "yellow_item_frame"), YELLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "lime_item_frame"), LIME_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "green_item_frame"), GREEN_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "cyan_item_frame"), CYAN_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "blue_item_frame"), BLUE_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "light_blue_item_frame"), LIGHT_BLUE_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "pink_item_frame"), PINK_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "magenta_item_frame"), MAGENTA_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "purple_item_frame"), PURPLE_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "black_item_frame"), BLACK_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "gray_item_frame"), GRAY_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "light_gray_item_frame"), LIGHT_GRAY_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "white_item_frame"), WHITE_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "brown_glow_item_frame"), BROWN_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "red_glow_item_frame"), RED_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "orange_glow_item_frame"), ORANGE_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "yellow_glow_item_frame"), YELLOW_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "lime_glow_item_frame"), LIME_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "green_glow_item_frame"), GREEN_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "cyan_glow_item_frame"), CYAN_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "blue_glow_item_frame"), BLUE_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "light_blue_glow_item_frame"), LIGHT_BLUE_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "pink_glow_item_frame"), PINK_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "magenta_glow_item_frame"), MAGENTA_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "purple_glow_item_frame"), PURPLE_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "black_glow_item_frame"), BLACK_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "gray_glow_item_frame"), GRAY_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "light_gray_glow_item_frame"), LIGHT_GRAY_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "white_glow_item_frame"), WHITE_GLOW_ITEM_FRAME);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "glass_shard"), GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "brown_glass_shard"), BROWN_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "red_glass_shard"), RED_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "orange_glass_shard"), ORANGE_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "yellow_glass_shard"), YELLOW_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "lime_glass_shard"), LIME_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "green_glass_shard"), GREEN_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "cyan_glass_shard"), CYAN_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "blue_glass_shard"), BLUE_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "light_blue_glass_shard"), LIGHT_BLUE_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "pink_glass_shard"), PINK_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "magenta_glass_shard"), MAGENTA_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "purple_glass_shard"), PURPLE_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "black_glass_shard"), BLACK_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "gray_glass_shard"), GRAY_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "light_gray_glass_shard"), LIGHT_GRAY_GLASS_SHARD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "white_glass_shard"), WHITE_GLASS_SHARD);
    ...
    private static void registerDecorativeBlocks() {
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_glass"), CHISELED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_glass_pane"), CHISELED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_brown_stained_glass"), CHISELED_BROWN_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_brown_stained_glass_pane"), CHISELED_BROWN_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_red_stained_glass"), CHISELED_RED_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_red_stained_glass_pane"), CHISELED_RED_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_orange_stained_glass"), CHISELED_ORANGE_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_orange_stained_glass_pane"), CHISELED_ORANGE_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_yellow_stained_glass"), CHISELED_YELLOW_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_yellow_stained_glass_pane"), CHISELED_YELLOW_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_lime_stained_glass"), CHISELED_LIME_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_lime_stained_glass_pane"), CHISELED_LIME_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_green_stained_glass"), CHISELED_GREEN_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_green_stained_glass_pane"), CHISELED_GREEN_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_cyan_stained_glass"), CHISELED_CYAN_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_cyan_stained_glass_pane"), CHISELED_CYAN_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_blue_stained_glass"), CHISELED_BLUE_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_blue_stained_glass_pane"), CHISELED_BLUE_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_light_blue_stained_glass"), CHISELED_LIGHT_BLUE_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_light_blue_stained_glass_pane"), CHISELED_LIGHT_BLUE_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_pink_stained_glass"), CHISELED_PINK_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_pink_stained_glass_pane"), CHISELED_PINK_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_magenta_stained_glass"), CHISELED_MAGENTA_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_magenta_stained_glass_pane"), CHISELED_MAGENTA_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_purple_stained_glass"), CHISELED_PURPLE_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_purple_stained_glass_pane"), CHISELED_PURPLE_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_black_stained_glass"), CHISELED_BLACK_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_black_stained_glass_pane"), CHISELED_BLACK_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_gray_stained_glass"), CHISELED_GRAY_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_gray_stained_glass_pane"), CHISELED_GRAY_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_light_gray_stained_glass"), CHISELED_LIGHT_GRAY_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_light_gray_stained_glass_pane"), CHISELED_LIGHT_GRAY_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_white_stained_glass"), CHISELED_WHITE_STAINED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_white_stained_glass_pane"), CHISELED_WHITE_STAINED_GLASS_PANE);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "lapis_stairs"), LAPIS_STAIRS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "lapis_slab"), LAPIS_SLAB);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "lapis_wall"), LAPIS_WALL);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "polished_lapis_block"), POLISHED_LAPIS_BLOCK);
        ...
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "mossy_brick_slab"), MOSSY_BRICK_SLAB);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "mossy_brick_wall"), MOSSY_BRICK_WALL);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "glass"), GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "shattered_glass"), SHATTERED_GLASS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_oak_planks"), CHISELED_OAK_PLANKS);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_oak_log"), CHISELED_OAK_LOG);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "chiseled_oak_wood"), CHISELED_OAK_WOOD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "stripped_chiseled_oak_log"), STRIPPED_CHISELED_OAK_LOG);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "stripped_chiseled_oak_wood"), STRIPPED_CHISELED_OAK_WOOD);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "cut_copper_wall"), CUT_COPPER_WALL);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "waxed_cut_copper_wall"), WAXED_CUT_COPPER_WALL);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "exposed_cut_copper_wall"), EXPOSED_CUT_COPPER_WALL);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "waxed_exposed_cut_copper_wall"), WAXED_EXPOSED_CUT_COPPER_WALL);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "weathered_cut_copper_wall"), WEATHERED_CUT_COPPER_WALL);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "waxed_weathered_cut_copper_wall"), WAXED_WEATHERED_CUT_COPPER_WALL);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "oxidized_cut_copper_wall"), OXIDIZED_CUT_COPPER_WALL);
        Registry.register(Registries.ITEM, Identifier.of(GreatBigWorld.NAMESPACE, "waxed_oxidized_cut_copper_wall"), WAXED_OXIDIZED_CUT_COPPER_WALL);
