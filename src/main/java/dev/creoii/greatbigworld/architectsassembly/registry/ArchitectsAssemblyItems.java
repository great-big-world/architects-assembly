...
public final class ArchitectsAssemblyItems {
    ...
    private static void registerDecorativeBlocks() {
        ...
        POLISHED_LAPIS_SLAB = RegistryHelper.registerItem(Identifier.of(GreatBigWorld.NAMESPACE, "polished_lapis_slab"), settings -> new SlabItem(ArchitectsAssemblyBlocks.POLISHED_LAPIS_SLAB, ArchitectsAssemblyBlocks.VERTICAL_POLISHED_LAPIS_SLAB, settings));
        ...
        POLISHED_LAPIS_BRICK_SLAB = RegistryHelper.registerItem(Identifier.of(GreatBigWorld.NAMESPACE, "polished_lapis_brick_slab"), settings -> new SlabItem(ArchitectsAssemblyBlocks.POLISHED_LAPIS_BRICK_SLAB, ArchitectsAssemblyBlocks.VERTICAL_POLISHED_LAPIS_BRICK_SLAB, settings));
    ...
    private static void registerMissingBlocks() {
        ...
        QUARTZ_BRICK_SLAB = RegistryHelper.registerItem(Identifier.of(GreatBigWorld.NAMESPACE, "quartz_brick_slab"), settings -> new SlabItem(ArchitectsAssemblyBlocks.QUARTZ_BRICK_SLAB, ArchitectsAssemblyBlocks.VERTICAL_QUARTZ_BRICK_SLAB, settings));
