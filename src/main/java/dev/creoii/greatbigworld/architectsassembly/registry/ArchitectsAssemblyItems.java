...
public final class ArchitectsAssemblyItems {
    ...
    private static void registerVerticalSlabs() {
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "oak_slab"), OAK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "spruce_slab"), SPRUCE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "birch_slab"), BIRCH_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "jungle_slab"), JUNGLE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "dark_oak_slab"), DARK_OAK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "acacia_slab"), ACACIA_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "mangrove_slab"), MANGROVE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "cherry_slab"), CHERRY_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "bamboo_slab"), BAMBOO_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "bamboo_mosaic_slab"), BAMBOO_MOSAIC_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "crimson_slab"), CRIMSON_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "warped_slab"), WARPED_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "stone_slab"), STONE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "smooth_stone_slab"), SMOOTH_STONE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "sandstone_slab"), SANDSTONE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "cut_sandstone_slab"), CUT_SANDSTONE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "petrified_oak_slab"), PETRIFIED_OAK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "cobblestone_slab"), COBBLESTONE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "brick_slab"), BRICK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "stone_brick_slab"), STONE_BRICK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "mud_brick_slab"), MUD_BRICK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "nether_brick_slab"), NETHER_BRICK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "quartz_slab"), QUARTZ_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "red_sandstone_slab"), RED_SANDSTONE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "cut_red_sandstone_slab"), CUT_RED_SANDSTONE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "purpur_slab"), PURPUR_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "prismarine_slab"), PRISMARINE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "prismarine_brick_slab"), PRISMARINE_BRICK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "dark_prismarine_slab"), DARK_PRISMARINE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "granite_slab"), GRANITE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "polished_granite_slab"), POLISHED_GRANITE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "andesite_slab"), ANDESITE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "polished_andesite_slab"), POLISHED_ANDESITE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "diorite_slab"), DIORITE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "polished_diorite_slab"), POLISHED_DIORITE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "smooth_sandstone_slab"), SMOOTH_SANDSTONE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "smooth_quartz_slab"), SMOOTH_QUARTZ_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "smooth_red_sandstone_slab"), SMOOTH_RED_SANDSTONE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "mossy_stone_brick_slab"), MOSSY_STONE_BRICK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "end_stone_brick_slab"), END_STONE_BRICK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "red_nether_brick_slab"), RED_NETHER_BRICK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "blackstone_slab"), BLACKSTONE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "polished_blackstone_slab"), POLISHED_BLACKSTONE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "polished_blackstone_brick_slab"), POLISHED_BLACKSTONE_BRICK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "oxidized_cut_copper_slab"), OXIDIZED_CUT_COPPER_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "weathered_cut_copper_slab"), WEATHERED_CUT_COPPER_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "exposed_cut_copper_slab"), EXPOSED_CUT_COPPER_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "cut_copper_slab"), CUT_COPPER_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "waxed_oxidized_cut_copper_slab"), WAXED_OXIDIZED_CUT_COPPER_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "waxed_weathered_cut_copper_slab"), WAXED_WEATHERED_CUT_COPPER_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "waxed_exposed_cut_copper_slab"), WAXED_EXPOSED_CUT_COPPER_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "waxed_cut_copper_slab"), WAXED_CUT_COPPER_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "cobbled_deepslate_slab"), COBBLED_DEEPSLATE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "polished_deepslate_slab"), POLISHED_DEEPSLATE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "deepslate_tile_slab"), DEEPSLATE_TILE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "deepslate_brick_slab"), DEEPSLATE_BRICK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "mossy_cobblestone_slab"), MOSSY_COBBLESTONE_SLAB);
    ...
    private static void registerImprovedBlocks() {
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "torch"), TORCH);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "soul_torch"), SOUL_TORCH);
        Registry.register(Registries.ITEM, new Identifier(ArchitectsAssembly.NAMESPACE, "redstone_lamp"), REDSTONE_LAMP);
